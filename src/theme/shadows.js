const shadows = [
  ...
  // MUI requires 25 shadow entries (indices 0-24), fill remaining with the last level
  ...Array(17).fill('16px 39px 67px 0px rgba(0,0,0,0.11), 1px 20px 65px 0px rgba(0,0,0,0.02), 2px 10px 10px 0px rgba(0,0,0,0.01), 0px -2px 6px 0px rgba(0,0,0,0.03)'),
];
