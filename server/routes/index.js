...
import restaurantPhotosRoutes from './restaurantPhotos.routes.js';
...
import adminSubscriptionRoutes from './adminSubscriptions.routes.js';
...
router.use('/restaurants/:restaurantId/photos', restaurantPhotosRoutes);
