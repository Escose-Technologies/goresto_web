...
import { createOrderSchema, updateOrderSchema, updateOrderStatusSchema, ordersQuerySchema } from '../validators/orders.validator.js';
...
router.get('/', validate(ordersQuerySchema, 'query'), ordersController.getAll);
